...
<div class="container">
    <div class="row card m-4">
        <div class="col-md-12 m-2">
            ...
            <p><a class="text-decoration-none" href="{{route('home')}}">Home</a> <i class="bi bi-arrow-right-short"></i><a class="text-decoration-none" href="{{route('education-detail')}}">Education Details</a> <i class="bi bi-arrow-right-short"></i> Edit Ug Degree</p>
