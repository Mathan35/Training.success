       ...
       <div class="row header">
           ...
           {{--- <a class = "text-decoration-none m-3"  href="{{route('view-roles')}}">View roles</a>
            <a class = "text-decoration-none m-3"  href="{{route('view-roles-permissions')}}">View Role and Permissions</a>  ---}}
                ...
                <a href="{{route('organization')}}" class="m-3 text-primary">create organization</a>
                ...
                <div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <th scope="row">1</th>
                            <td>{{$data->name}}</td>                
                            <td><a class = "text-decoration-none text-primary" href="{{route('edit-organization', $data->id)}}">Edit</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
