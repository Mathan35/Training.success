       ...
       <div class="row header">
           ...
           {{--- <a class = "text-decoration-none m-3"  href="{{route('view-roles')}}">View roles</a>
            <a class = "text-decoration-none m-3"  href="{{route('view-roles-permissions')}}">View Role and Permissions</a>  ---}}
                ...
                <a href="{{route('organization-role')}}" class="m-3 text-primary">create Role</a>
                ...
                <div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td>{{$data->name}}</td>                
                            <td>
                                @foreach($data->getOrganizationPermissions as $value)
                                {{$value->name}},
                                @endforeach
                            </td>
                            <td><a class = "text-decoration-none" href="{{route('edit-organization-role', $data->id)}}">Edit</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
